...
async def cmd_help(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "/search စာအုပ်နာမည် သို့မဟုတ် စာရေးသူ - ရှာဖွေရန်\n"
        "/find စာအုပ်နာမည် - /search နဲ့ အတူတူပါပဲ\n"
        "/refresh - Reload data\n"
        "/stats - Statistics\n\n"
        "*\U0001f3af Quick Search:*\n"
        "/ဂျူး, /sဂျူး, /fဂျူး - ရိုက်ရုံနဲ့ ရှာနိုင်\n"
        "/searchဂျူး, /findဂျူး - space မခြားဘဲ ရှာနိုင်\n\n"
        "*\U0001f4dd Book Notes:*\n"
        "/addnote book - 5 - Add note\n"
        "/note book - View notes\n"
        "/mynote - Your notes\n"
        "/delnote <id> - Delete note\n\n"
        "*\U0001f510 Author Alias:*\n"
        "/addalias alias = စာရေးသူ - Alias ထည့်\n"
        "/delalias alias - Alias ဖျက်\n"
        "/aliaslist - Aliases ကြည့်\n\n"
        "*\U0001f6ab Keyword Filter:*\n"
        "/Addword စကားလုံး - Keyword block ထည့်\n"
        "/Delword စကားလုံး - Keyword block ဖျက်\n"
        "/wordlist - Blocked keywords ကြည့်\n\n"
        "*\U0001f512 Link & Forward Protection:*\n"
        "Forward (link ပါပါ မပါပါ)\n"
        "မှန်သမျှ ဖျက်ပါတယ်။\n"
        "ခွင့်ပြု bot: wowepubsearch, MissRose\n\n"
        "Link (https, t.me, www, domain)\n"
        "Whitelist ထဲမပါရင် ဖျက်ပါတယ်။\n\n"
        "*\u2699\ufe0f Admin:*\n"
...
async def cmd_search(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    if not ctx.args:
        sent = await update.message.reply_text("အသုံးပြုပုံ - /search စာအုပ်နာမည် (သို့) စာရေးသူ နာမည် ရေးပါ။ /search ရေးပြီး space ခြားပြီးမှာ စာရေးသူ (သို့မဟုတ်) စာအုပ်နာမည် ရေးပါ။\n\nဥပမာ - /search မင်းကျော်")
        return
    query = " ".join(ctx.args)
